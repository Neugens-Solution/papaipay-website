    ...
    <main className="min-h-screen bg-[#f7fbf8] text-slate-950">
      ...
      <section id="henry" className="relative min-h-[700px] overflow-hidden bg-[#052315] text-white lg:min-h-[760px]">
        ...
        <div className="relative mx-auto flex min-h-[700px] max-w-7xl flex-col justify-between px-5 py-14 md:px-10 lg:min-h-[760px] lg:px-8 lg:py-20">
            ...
            <div className="mt-14 grid gap-0 rounded-3xl border border-white/10 bg-black/30 p-6 shadow-2xl shadow-black/20 backdrop-blur-md md:grid-cols-3 md:gap-5 md:border-0 md:bg-transparent md:p-0 md:shadow-none lg:gap-0 lg:divide-x lg:divide-white/10 lg:pt-0">
              {henryHighlights.map(([icon, title, text], index) => (
                <div key={title} className="md:rounded-3xl md:border md:border-white/10 md:bg-black/25 md:p-6 md:shadow-2xl md:shadow-black/15 md:backdrop-blur-md lg:rounded-none lg:border-0 lg:bg-transparent lg:px-10 lg:shadow-none lg:first:pl-0 lg:last:pr-0">
                  ...
                  {index < henryHighlights.length - 1 && <div className="my-7 h-px w-20 bg-[#d6b95f]/70 md:hidden" />}
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="relative mx-auto mt-14 grid max-w-7xl gap-5 md:grid-cols-2 lg:grid-cols-4">
          {journeySteps.map(([number, icon, title, text]) => (
            <div key={number} className="group relative rounded-[1.75rem] border border-emerald-100 bg-white/95 p-7 text-center shadow-xl shadow-emerald-950/5 transition hover:-translate-y-1 hover:border-emerald-200 hover:shadow-2xl hover:shadow-emerald-950/10">
              ...
              <div className="mx-auto mt-4 grid h-[4.25rem] w-[4.25rem] place-items-center rounded-full bg-gradient-to-br from-emerald-50 to-white text-brand-700 ring-1 ring-emerald-100 shadow-inner shadow-emerald-950/5">
                <LineIcon name={icon} className="h-[2.125rem] w-[2.125rem]" />
              </div>
          ...
          <div className="mt-12 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            {credibilityStats.map(([icon, stat, label, text]) => (
              <div key={label} className="rounded-[1.25rem] border border-[#d6b95f]/30 bg-white/10 p-7 text-center shadow-2xl shadow-black/10 backdrop-blur-md">
                ...
                <div className={`mt-5 font-extrabold tracking-[-0.06em] text-white ${stat === "RM450 Juta" ? "text-[2rem] md:text-[2.75rem]" : "text-5xl md:text-6xl"}`}>{stat}</div>
