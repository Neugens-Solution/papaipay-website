    ...
    <main className="min-h-screen bg-[#f7fbf8] text-slate-950">
      ...
      <section className="relative flex min-h-[190px] items-center justify-center overflow-hidden pt-16 text-center text-white md:min-h-[320px] md:pt-16">
        ...
        <div className="relative mx-auto w-full max-w-7xl px-5 py-8 md:py-16 lg:px-8">
          <h1 className="text-3xl font-extrabold leading-[1.05] tracking-[-0.05em] md:text-4xl lg:text-5xl">Kerjaya</h1>
        </div>
      </section>
      ...
      <section className="bg-white px-5 py-20 lg:px-8 lg:py-24">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-4 text-3xl font-extrabold leading-[1.04] tracking-[-0.045em] text-slate-950 md:text-5xl">Bina Kerjaya Anda Bersama Papaipay</h2>
          ...
          <div className="rounded-[2rem] border border-emerald-100 bg-[#f7fbf8] p-8 shadow-2xl shadow-emerald-950/10 md:p-10">
            ...
            <h3 className="mt-4 text-2xl font-extrabold leading-tight tracking-[-0.04em] text-slate-950">Setiap peranan menyumbang kepada pengalaman pelanggan yang lebih baik.</h3>
      ...
      <section className="bg-white px-5 py-20 lg:px-8 lg:py-24"><div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.82fr_1.18fr] lg:items-start"><div className="lg:sticky lg:top-28"><p className="text-xs font-extrabold uppercase tracking-[0.28em] text-brand-700">Nilai Kami</p><h2 className="mt-4 text-3xl font-extrabold leading-[1.04] tracking-[-0.045em] text-slate-950 md:text-5xl">Nilai Kami</h2><p className="mt-6 max-w-md text-base leading-8 text-slate-600">Nilai kami membentuk cara kami bekerja, berinteraksi dan memberikan perkhidmatan kepada pelanggan.</p></div><div className="grid gap-5 md:grid-cols-2">{values.map(([title, text]) => <article key={title} className="rounded-[1.5rem] border border-emerald-100 bg-[#f7fbf8] p-7 shadow-xl shadow-emerald-950/5"><div className="mb-7 h-1 w-12 rounded-full bg-[#d6b95f]" /><h3 className="text-xl font-extrabold leading-tight tracking-[-0.04em] text-slate-950">{title}</h3><p className="mt-4 text-sm leading-7 text-slate-600">{text}</p></article>)}</div></div></section>
      ...
      <section className="bg-[#f7fbf8] px-5 py-20 lg:px-8 lg:py-24"><div className="mx-auto max-w-7xl"><SectionHeading title="Peluang Kerjaya Semasa" intro="Terokai peluang kerjaya bersama Papaipay dan sertai pasukan yang komited untuk memberi nilai kepada pelanggan." /><div className="mt-12 grid gap-5 md:grid-cols-2">{opportunities.map(([title, text]) => <article key={title} className="rounded-[1.75rem] border border-emerald-100 bg-white p-7 shadow-xl shadow-emerald-950/5"><div className="flex flex-wrap items-start justify-between gap-4"><h3 className="text-2xl font-extrabold leading-tight tracking-[-0.04em] text-slate-950">{title}</h3><span className="rounded-full bg-emerald-50 px-4 py-2 text-[11px] font-extrabold uppercase tracking-[0.12em] text-brand-700">Dibuka Untuk Permohonan</span></div><p className="mt-5 text-sm leading-7 text-slate-600">{text}</p><a href="#submit-resume" className="mt-7 inline-flex rounded-full bg-brand-700 px-6 py-3 text-xs font-extrabold uppercase tracking-[0.12em] text-white shadow-lg shadow-emerald-950/15 transition hover:-translate-y-0.5 hover:bg-brand-900">Mohon Sekarang</a></article>)}</div></div></section>

      <section className="bg-white px-5 py-20 lg:px-8 lg:py-24"><div className="mx-auto max-w-7xl rounded-[2rem] border border-emerald-100 bg-[#f7fbf8] p-8 text-center shadow-2xl shadow-emerald-950/10 md:p-12"><h2 className="text-3xl font-extrabold leading-tight tracking-[-0.045em] text-slate-950 md:text-5xl">Tidak Menemui Jawatan Yang Sesuai?</h2><p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-slate-600">Kami sentiasa berminat untuk berhubung dengan individu yang berbakat dan bermotivasi. Jika anda percaya anda boleh menyumbang kepada Papaipay, kami mengalu-alukan permohonan anda.</p><a href="#submit-resume" className="mt-8 inline-flex rounded-full bg-brand-700 px-8 py-4 text-xs font-extrabold uppercase tracking-[0.12em] text-white shadow-xl shadow-emerald-950/15 transition hover:-translate-y-0.5 hover:bg-brand-900">Hantar Resume Anda</a></div></section>
        ...
        <div className="mx-auto grid max-w-7xl overflow-hidden rounded-[2.25rem] border border-emerald-100 bg-white shadow-2xl shadow-emerald-950/10 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="relative overflow-hidden bg-[linear-gradient(135deg,#082314_0%,#0b301d_55%,#031a0e_100%)] p-8 text-white md:p-12">
            ...
            <div className="relative">
              ...
              <h2 className="mt-6 text-3xl font-extrabold leading-[1.04] tracking-[-0.045em] md:text-5xl">Hantar Resume Anda</h2>
      ...
      <section className="bg-white px-5 pb-20 lg:px-8 lg:pb-24"><div className="relative mx-auto max-w-7xl overflow-hidden rounded-[2rem] bg-[linear-gradient(135deg,#082314_0%,#0b301d_52%,#031a0e_100%)] p-8 text-center text-white shadow-2xl shadow-emerald-950/20 md:p-14"><div className="absolute inset-0 bg-cover bg-center opacity-[0.12]" style={{ backgroundImage: "url('/hero-career.png')" }} /><div className="absolute inset-0 bg-black/25" /><div className="relative"><h2 className="mx-auto max-w-3xl text-3xl font-extrabold leading-tight tracking-[-0.045em] md:text-5xl">Sedia Menyertai Papaipay?</h2><p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-white/78">Ambil langkah seterusnya dalam perjalanan kerjaya anda dan berkembang bersama kami.</p><a href="#submit-resume" className="mt-9 inline-flex rounded-full bg-white px-8 py-4 text-xs font-extrabold uppercase tracking-[0.12em] text-brand-900 shadow-xl transition hover:-translate-y-0.5 hover:bg-white/90">Mohon Sekarang</a></div></div></section>
