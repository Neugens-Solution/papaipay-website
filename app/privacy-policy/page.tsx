    ...
    <main className="min-h-screen bg-[#f7fbf8] text-slate-950">
      ...
      <section className="relative flex min-h-[260px] items-center justify-center overflow-hidden pt-16 text-center text-white md:min-h-[360px]">
        ...
        <div className="relative mx-auto max-w-4xl px-5 py-16 lg:px-8">
          ...
          <h1 className="mt-4 text-4xl font-bold leading-[1.05] tracking-[-0.05em] md:text-5xl lg:text-6xl">Dasar Privasi</h1>
          <p className="mt-6 text-base leading-8 text-white/75 md:text-lg">Maklumat ini menerangkan bagaimana Papaipay menguruskan maklumat peribadi yang dikongsi melalui laman web ini.</p>
        </div>
      </section>
