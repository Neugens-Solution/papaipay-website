...
const actions = [
  { label: "Whatsapp", href: "https://wa.me/60182455745" },
  { label: "+60182455745", href: "tel:+60182455745" },
  { label: "papaipay.my@gmail.com", href: "mailto:papaipay.my@gmail.com" },
];

export default function KakRosProfilePage() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#f7fbf8] px-5 py-16 text-slate-950">
      <section className="w-full max-w-md text-center">
        <div className="mx-auto h-40 w-40 overflow-hidden rounded-full border-4 border-white bg-white shadow-2xl shadow-emerald-950/12 md:h-48 md:w-48">
          <Image src="/faten.jpg" alt="KAK ROS (FATEN)" width={240} height={240} priority className="h-full w-full object-cover object-top" />
        </div>
        <h1 className="mt-8 text-3xl font-extrabold leading-tight tracking-[-0.045em] md:text-4xl">KAK ROS (FATEN)</h1>
