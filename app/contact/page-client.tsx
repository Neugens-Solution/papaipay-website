...
const contactCards = [
  ...
  },
  {
    ...
    description:
      "Hantar pertanyaan anda dan pasukan kami akan menyemaknya sebelum menghubungi anda semula.",
  },
  {
    title: "Kunjungi Kami",
    value:
    ...
    description:
      "Kunjungi pejabat kami untuk sesi konsultasi dan temujanji yang telah dijadualkan.",
  },
  {
    title: "Waktu Operasi",
    value: "Isnin – Jumaat\n10:00 Pagi – 6:00 Petang\n\nSabtu – Ahad\nTutup",
    description:
      "Temujanji digalakkan supaya pasukan kami boleh membuat persediaan untuk sesi konsultasi anda.",
  },
];
    ...
    <main className="min-h-screen bg-[#f7fbf8] text-slate-950">
      ...
      <section className="px-5 py-16 lg:px-8 lg:py-20">
        <div className="mx-auto max-w-3xl text-center">
          <p className="text-xs font-extrabold uppercase tracking-[0.28em] text-brand-700">
            Berhubung Dengan Papaipay
          </p>
          <h2 className="mt-4 text-3xl font-bold leading-[1.04] tracking-[-0.045em] text-slate-950 md:text-5xl">
            Kami Sedia Membantu Anda
          </h2>
          <p className="mt-5 text-base leading-8 text-slate-600 md:text-lg">
            Hubungi Papaipay untuk pertanyaan, sesi konsultasi dan urusan
            temujanji bersama pasukan kami.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto grid max-w-7xl overflow-hidden rounded-[2.25rem] border border-emerald-100 bg-[#f7fbf8] shadow-2xl shadow-emerald-950/10 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="relative overflow-hidden bg-[linear-gradient(135deg,#082314_0%,#0b301d_55%,#031a0e_100%)] p-8 text-white md:p-12">
            ...
            <div className="relative">
              ...
              <h2 className="mt-6 text-3xl font-bold leading-[1.04] tracking-[-0.045em] md:text-5xl">
                Kongsikan Maklumat Anda Dengan Pasukan Kami
              </h2>
              <p className="mt-5 max-w-xl text-base leading-8 text-white/74">
                Lengkapkan borang ini dan pasukan kami akan menyemak pertanyaan
                anda sebelum menghubungi anda semula dengan langkah seterusnya.
              </p>
              <ul className="mt-8 grid gap-3 text-sm font-semibold text-white/82">
                {[
                  "Sokongan khidmat nasihat profesional",
                  "Langkah seterusnya yang lebih jelas",
                  "Panduan dokumen jika diperlukan",
                ].map((item) => (
              ...
              <div className="mt-10 rounded-2xl border border-white/10 bg-white/10 p-5 text-sm font-semibold leading-7 text-white/78">
                Untuk pertanyaan segera, sila hubungi kami melalui telefon pada
                waktu pejabat.
              </div>
            </div>
          </div>
          <form onSubmit={handleSubmit} className="p-6 md:p-10">
            <div className="grid gap-5 md:grid-cols-2">
              <Field label="Nama Penuh" name="name" placeholder="Nama anda" />
              <Field
              ...
              />
              <label className="grid gap-2 text-sm font-extrabold text-slate-800">
                <span>Perkhidmatan Yang Diminati</span>
                <select
                  required
                  name="enquiryType"
            ...
            <label className="mt-5 grid gap-2 text-sm font-extrabold text-slate-800">
              ...
              <textarea
                ...
                name="message"
                rows={6}
                placeholder="Ceritakan secara ringkas tentang pertanyaan anda."
            ...
            {status === "success" && (
              ...
              >
                Terima kasih. Pertanyaan anda telah dihantar kepada pasukan
                Papaipay.
              </p>
            )}
            {status === "error" && (
      ...
      <section className="bg-[#f7fbf8] px-5 py-20 lg:px-8 lg:py-24">
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-3xl text-center">
            <p className="text-xs font-extrabold uppercase tracking-[0.28em] text-brand-700">
              Kunjungi Pejabat Kami
            </p>
            <h2 className="mt-4 text-3xl font-bold leading-[1.04] tracking-[-0.045em] text-slate-950 md:text-5xl">
              Kunjungi Pejabat Kami
            </h2>
            <p className="mt-5 text-base leading-8 text-slate-600 md:text-lg">
              Pejabat kami terletak di Bandar Sri Damansara dan boleh dikunjungi
              untuk sesi konsultasi serta temujanji yang telah dijadualkan.
            </p>
          </div>
      ...
      <section className="bg-white px-5 py-20 lg:px-8 lg:py-24">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <h2 className="mt-4 text-3xl font-bold leading-[1.04] tracking-[-0.045em] text-slate-950 md:text-5xl">
            Kekal berhubung dengan Papaipay.
          </h2>
        ...
        <div className="relative mx-auto max-w-7xl overflow-hidden rounded-[2rem] bg-[linear-gradient(135deg,#082314_0%,#0b301d_52%,#031a0e_100%)] p-8 text-center text-white shadow-2xl shadow-emerald-950/20 md:p-14">
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-white/78">
              Berhubung dengan pasukan kami untuk mengetahui lebih lanjut
