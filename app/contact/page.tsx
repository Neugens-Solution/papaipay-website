        ...
        <div className="mx-auto grid max-w-7xl overflow-hidden rounded-[2.25rem] border border-emerald-100 bg-[#f7fbf8] shadow-2xl shadow-emerald-950/10 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="relative overflow-hidden bg-[linear-gradient(135deg,#082314_0%,#0b301d_55%,#031a0e_100%)] p-8 text-white md:p-12">
            ...
            <div className="relative">
              ...
              <p className="mt-5 max-w-xl text-base leading-8 text-white/74">Complete the form and our team will review your enquiry before getting back to you with the next steps.</p>
              <ul className="mt-8 grid gap-3 text-sm font-semibold text-white/82">
                {['Professional advisory support', 'Clear next steps', 'Document guidance where required'].map((item) => <li key={item} className="flex items-center gap-3"><span className="h-2 w-2 rounded-full bg-[#d6b95f]" />{item}</li>)}
              </ul>
              <div className="mt-10 rounded-2xl border border-white/10 bg-white/10 p-5 text-sm font-semibold leading-7 text-white/78">For urgent enquiries, please contact us by phone during office hours.</div>
            </div>
          </div>
