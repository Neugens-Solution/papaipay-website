      ...
      <section className="bg-white px-5 py-16 lg:px-8 lg:py-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-4 text-3xl font-bold leading-[1.04] tracking-[-0.045em] text-slate-950 md:text-5xl">
            Request an Initial Review With Papaipay
          </h2>
          <p className="mt-5 text-base leading-8 text-slate-600 md:text-lg">
            Complete the brief details below to help our team understand your
            financial situation before recommendations or next steps are shared.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto grid max-w-7xl overflow-hidden rounded-[2.25rem] border border-emerald-100 bg-[#f7fbf8] shadow-2xl shadow-emerald-950/10 lg:grid-cols-[0.9fr_1.1fr]">
          <aside className="relative overflow-hidden bg-[linear-gradient(135deg,#082314_0%,#0b301d_55%,#031a0e_100%)] p-8 text-white md:p-12">
            ...
            <div className="relative">
              ...
              <p className="mt-5 max-w-xl text-base leading-8 text-white/74">
                This information helps the Papaipay team conduct an initial
                review based on your profile and needs.
              </p>
              <ul className="mt-8 grid gap-3 text-sm font-semibold text-white/82">
                {[
                  "Initial review based on your information",
                  "Guidance on next steps",
                  "No approval guarantee is provided",
                ].map((item) => (
              ...
              <div className="mt-10 border-t border-white/10 pt-8">
                ...
                <p className="mt-4 text-xs font-medium leading-6 text-white/60 md:text-sm md:leading-7">
                  The information submitted is for initial review only and does
                  not guarantee approval of any financing facility, financial
                  solution or asset participation. Any recommendation is subject
                  to further assessment based on the customer’s profile,
          ...
          <form noValidate onSubmit={handleSubmit} className="p-6 md:p-10">
            ...
            <div className="mt-8 space-y-8">
              ...
              <section aria-labelledby="current-situation-title">
                ...
                <div className="mt-5 grid gap-5">
                  <RadioGroup
                    legend="Do you have a bank loan or credit card that has been active for more than 6 months?"
                    name="hasActiveCredit"
                  />
                  <RadioGroup
                    legend="Have you ever been late on payments for 2 consecutive months?"
                    name="hasLatePayment"
                  />
                  <label className={labelClass}>
              ...
              <section aria-labelledby="additional-info-title">
                ...
                <label className="mt-5 grid gap-2 text-sm font-extrabold text-slate-800">
                  ...
                  <textarea
                    name="message"
                    rows={5}
                    placeholder="Briefly tell us about your needs or situation."
            ...
            {status === "success" && (
              ...
              >
                Thank you. Your details have been submitted to the Papaipay
                team.
              </p>
            )}
            {status === "error" && (
        ...
        <div className="relative mx-auto max-w-7xl overflow-hidden rounded-[2rem] bg-[linear-gradient(135deg,#082314_0%,#0b301d_52%,#031a0e_100%)] p-8 text-center text-white shadow-2xl shadow-emerald-950/20 md:p-14">
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-white/78">
              If you have questions, our team is ready to help you understand
              suitable options before proceeding with the review.
            </p>
            <a
              href="/en/contact"
