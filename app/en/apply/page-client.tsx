      ...
      <section className="bg-white px-5 pb-20 lg:px-8 lg:pb-24">
        <div className="mx-auto grid max-w-7xl overflow-hidden rounded-[2.25rem] border border-emerald-100 bg-[#f7fbf8] shadow-2xl shadow-emerald-950/10 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <form noValidate onSubmit={handleSubmit} className="p-6 md:p-10">
            ...
            <p role="status" className="mt-6 rounded-2xl border border-amber-200 bg-amber-50 px-5 py-4 text-sm font-bold leading-7 text-amber-900">This online form is being prepared. For immediate enquiries, please contact the Papaipay team by phone or email.</p>

            <a href="/en/contact" className="mt-7 inline-flex w-full justify-center rounded-full bg-brand-700 px-8 py-4 text-xs font-extrabold uppercase tracking-[0.14em] text-white shadow-xl shadow-emerald-950/15 transition hover:-translate-y-0.5 hover:bg-brand-900 md:w-auto">
              Contact Us
            </a>
          </form>
        </div>
